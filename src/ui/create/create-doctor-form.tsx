    ...
    <form onSubmit={handleSubmit} className="space-y-8 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="name" placeholder="Ingrese el nombre del médico" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="lastName" placeholder="Ingrese el apellido del médico" />
        </div>

        <div className="space-y-2">
          <label htmlFor="registrationNumber" className="block text-sm font-medium text-gray-700">Número de Matricula</label>
          <Input id="registrationNumber" placeholder="Ingrese el número de matrícula" />
        </div>
