...
import { Menu, X, Hospital, Search, PowerIcon, User2, Clock } from 'lucide-react';
      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-center items-center w-full h-16">
          ...
          <div className="hidden md:flex space-x-1">
            ...
            <UserOptionsButton userName={userName} rol={"Administrador"}/>
          </div>
          <button
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 text-center">
            ...
            <MobileNavLink href="/password/change" icon={PowerIcon}>
              <UserOptionsButton rol = "administrador" userName={userName}/>
            </MobileNavLink>
          </div>
        </div>
      )}
