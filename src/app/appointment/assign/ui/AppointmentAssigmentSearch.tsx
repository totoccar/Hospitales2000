...
export default function AppointmentSearch({ especialidades, patient_id }: { especialidades: Especialidad[], patient_id: string }){
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/appointment/assign?${queryParams.toString()}`)
  }
