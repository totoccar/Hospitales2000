...
export default async function AssigmentTable({
  dni,
  apellido,
  especialidad,
  tipoDocumento,
  ...
  return (
    <div className="mt-6 flow-root">
      ...
      <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
        {!dni && !apellido && !especialidad ? (
        <div className="text-center py-3">
          Empieza buscando el profesional deseado para reservar una cita
        </div>
        ) : (
        <>
          ...
          <tbody className="bg-white">
            ...
            doctors?.map((doctor) => (
              <tr
                ...
                className="w-full border-b-2 text-md last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg bg-fondo [&:last-child>td:last-child]:rounded-br-lg"
              >
